(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__slider-pros")) {
            new swiper_core_Swiper(".hero__slider-pros", {
            ...
            new swiper_core_Swiper(".hero__slider-product", {
...
***************************************************************************** */
    ...
    da.init();
    const animateText = () => {
        const elementsToAnimate = document.querySelectorAll("[data-text-animate]");
    ...
    const modules_animateText = animateText;
    const scrollUp = document.querySelector(".scroll-up");
    function toggleScrollUp() {
        scrollUp.classList.toggle("active", window.scrollY > 1e3);
    }
